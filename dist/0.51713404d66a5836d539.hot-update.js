...
var getChildren = function getChildren(host) {
  return Array.from(host.children).filter(function (el) {
    return !el.nonchild && get_1["default"](el, "tagName.toLowerCase()") !== "style";
  });
};

var getCurrent = function getCurrent(host) {
  return Array.from(host.children).filter(function (c) {
    return !c.getAttribute("slot") && !c.nonchild && get_1["default"](c, "tagName.toLowerCase()") !== "style";
  })[0];
};
...
exports.getIndex = function (host) {
  return function () {
    return getChildren(host).indexOf(getCurrent(host));
  };
};

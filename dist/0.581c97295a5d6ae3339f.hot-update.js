...
var getVal = function getVal(host, value) {
  ...
  if (host.musthave) {
    console.log(maxMined.value.test(new RegExp(host.musthave, "g")));
    mustHaveValid = maxMined.value.test(new RegExp(host.musthave, "g"));
  }

  sanitized.valid = sanitized.valid && maxMined.valid && mustHaveValid; // musthave

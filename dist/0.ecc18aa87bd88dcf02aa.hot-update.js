...
var transitionSlide = function transitionSlide(host, index, speed, keepchildren) {
  return new Promise(function (resolve) {
    ...
    console.log("slide", elements, host.type);
...
var transitionFade = function transitionFade(host, child, speed, keepchildren) {
  return new Promise(function (resolve) {
    ...
    console.log("fade", elements, host.type);
...
var Router = function Router(routes) {
  ...
  var updateState = function updateState(route, replace, force) {
    ...
    console.log("updating path:", route.pathname, "; currentQuery:", currentQuery, "; lastQuery:", lastQuery);
  ...
  var handleRoute = function handleRoute(url, replace, force) {
    ...
    if (route.allowedQueries && Array.isArray(route.allowedQueries)) {
      console.log(route.pathname, Object.keys(query), route.allowedQueries);
    ...
    console.log("matchey?", routePath === currentPath, currentQuery === routeQuery);
    console.log("Present to you", routeQuery, " and ", query);

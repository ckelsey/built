...
var getVal = function getVal(host, value) {
  ...
  if (!matchInputValid) {
    var name_1 = get_1["default"](host, "matchinput.label", get_1["default"](host, "matchinput.placeholder", get_1["default"](host, "matchinput.name", host.matchinput.getAttribute("label") || host.matchinput.getAttribute("placeholder") || host.matchinput.getAttribute("name"))));
    sanitized.reason.push("Value does not match" + (name_1 ? " " + name_1 : "") + ".");
  }
